...
import org.openhab.binding.polyglot.internal.PolyglotConfiguration;
 ...
 */
@NonNullByDefault
public class PolyglotHandler extends BaseThingHandler {
    ...
    public PolyglotHandler(Thing thing) {
        super(thing);
    }
